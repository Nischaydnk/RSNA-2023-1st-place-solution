...
from coat_lite_medium_bs2_lr_seed_cfg import CFG
...
from coat_lite_medium_bs2_lr_seed_model import Model, define_criterion_optimizer_scheduler_scaler
...
if __name__ == '__main__' and CFG.DDP:
    ...
    OUTPUT_FOLDER = f"{CFG.OUTPUT_FOLDER}_lr{args.lr}_seed{CFG.seed}"
