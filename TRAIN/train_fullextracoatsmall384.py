...
from fullextracoatsmall384_cfg import CFG
...
from fullextracoatsmall384_model import Model, define_criterion_optimizer_scheduler_scaler
...
if __name__ == '__main__' and CFG.DDP:
    ...
    CFG.seed = args.seed
    CFG.FOLD = CFG.seed #bypass to save
    ...
    train_loader, valid_loader = get_loaders()
    model = Model(arch='small',pre = f'{PATHS.COAT_PRETRAINED}/coat_lite_small_8d362f48.pth', mask_head = True).cuda()
