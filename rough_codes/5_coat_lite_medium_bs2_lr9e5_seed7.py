...
class CFG:
    ...
    OUTPUT_FOLDER = f"coat_lite_medium_bs2_lr9e5_seed7"
...
study_level = pd.read_csv('/home/user/src/rsna-2023-abdominal-trauma-detection/train_v2.csv')
...
data = pd.read_csv('/home/user/src/rsna-2023-abdominal-trauma-detection/info_data1_processed_v2.csv')
data
...
class AbdDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        vol = np.load(f"/mnt/data2/data_theo/{patient}_{study}_{start}_{end}.npy")        
...
from src_inference1.coat import CoaT,coat_lite_mini,coat_lite_small,coat_lite_medium
from src_inference1.layers import *
